...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: Let allows a variable to be scope to a code block rather than var which receives global or local scope. What this means is const is a little bit more detailed in what it targets so an error occurs because it looks to a code block. 
  console.log(viewed);
